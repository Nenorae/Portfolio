<div
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="p-6 border-b border-[#262626]">
            <h2 class="text-2xl font-bold mt-2 text-white">Notifikasi</h2>
        </div>
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar">
            ...
            <div x-show="!isLoading && notifications.length === 0" class="flex flex-col items-center justify-center py-20 text-center px-6">
                <div class="w-12 h-12 border-2 border-white rounded-full flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                    </svg>
                </div>
                <p class="text-sm text-white font-bold">Aktivitas di postinganmu</p>
                <p class="text-xs text-gray-400 mt-1">Saat seseorang menyukai atau mengomentari postinganmu, kamu akan melihatnya di sini.</p>
            </div>
            ...
            <div x-show="!isLoading && notifications.length > 0">
                <template x-for="notif in notifications" :key="notif.id">
                    <div
                        ...
                        class="flex items-center justify-between px-6 py-4 hover:bg-white/5 cursor-pointer transition-colors">
                        <div class="flex items-center gap-4">
                            <div class="relative">
                                ...
                                <div class="absolute -bottom-1 -right-1 rounded-full p-1 border border-black"
                            ...
                            <div class="text-sm">
                                <p class="text-white leading-snug">
                                    ...
                                    <span class="text-gray-400 text-xs ml-1" x-text="notif.created_at_human"></span>
                                </p>
                            </div>
                        </div>
